...
<body class="sb-nav-fixed">
  ...
  <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1z"/>
        ...
        <center>
        <h1 style="margin-top:50px;">Data Lokasi Buku</h1>
        <a class="btn btn-secondary" href="form_rak.php" role="button" style="margin-top:20px; margin-bottom:20px;">
    ...
    {?>
        <tbody>
            <tr>
                ...
                <td>
                <center>
                    <a href="edit_rak.php?id_rak=<?php echo $data['id_rak']; ?>"> <button type="button" class="btn btn-outline-secondary">
                    ...
                    Edit</button></a>
                    <a href="hapus_rak.php?id_rak=<?php echo $data['id_rak']; ?>">  <button type="button" class="btn btn-danger">
