...
<body class="sb-nav-fixed">
  ...
  <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1z"/>
        ...
        <center>
        <h1 style="margin-top:50px;">Data Transaksi</h1>
        <a class="btn btn-secondary" href="form_pinjam.php" role="button" style="margin-top:20px; margin-bottom:20px;">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
        <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2"/></svg>
        Tambah Data</a>

        <form action="datatransaksi.php" method="get" class="d-flex mt-3 col-3" role="search">
        <input class="form-control me-1" type="search" placeholder="Search" aria-label="Search" name="cari">
    ...
    if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    // Ubah kueri SQL untuk mencari data yang mengandung teks pencarian
    $query = "SELECT peminjaman.*, buku.judul_buku, anggota.kode_anggota, anggota.nama_anggota 
              FROM peminjaman 
              INNER JOIN buku ON peminjaman.id_buku = buku.id_buku 
              INNER JOIN anggota ON peminjaman.id_anggota = anggota.id_anggota WHERE nama_anggota LIKE '%$cari%'";
    } else {
            ...
            <tr>
                ...
                <td>
                    <?php 
                        ...
                        echo ($hari_terlambat > 0) ? $hari_terlambat : 0 ; 
                    ?></td>
                <td>
                <center>
                    <a href="kembali.php?id_peminjaman=<?php echo $data['id_peminjaman']; ?>"> <button type="button" class="btn btn-outline-secondary">
                    ...
                    Kembalikan</button></a>
                    <a href="perpanjang.php?id_peminjaman=<?php echo $data['id_peminjaman']; ?>">  <button type="button" class="btn btn-info">
                    <i class="far fa-calendar-plus"></i> Perpanjang</button></a>
                </center>
                </td>
            </tr>
        </tbody>
