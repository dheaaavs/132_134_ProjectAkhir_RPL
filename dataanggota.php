...
<body class="sb-nav-fixed">
  ...
  <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1z"/>
        ...
        <a class="btn btn-secondary" href="form_anggota.php" role="button" style="margin-top:20px; margin-bottom:20px;">
        ...
        <form action="dataanggota.php" method="get" class="d-flex mt-3 col-3" role="search">
    ...
    $query = "SELECT * FROM anggota WHERE nama_anggota LIKE '%$cari%'";
    } else {
    // Jika tidak ada pencarian, tampilkan semua data anggota
    ...
    ?>
        <tbody>
            <tr>
                ...
                <td>
                <center>
                    <a href="edit_anggota.php?id_anggota=<?php echo $data['id_anggota']; ?>"> <button type="button" class="btn btn-outline-secondary">
                    ...
                    Edit</button></a>
                    <a href="hapus_anggota.php?id_anggota=<?php echo $data['id_anggota']; ?>">  <button type="button" class="btn btn-danger">
