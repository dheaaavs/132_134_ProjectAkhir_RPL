...
<body class="sb-nav-fixed">
  ...
  <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1z"/>
        ...
        <a class="btn btn-secondary" href="form_buku.php" role="button" style="margin-top:20px; margin-bottom:20px;">
    ...
    <form action="databuku.php" method="get" class="d-flex mt-3 col-3" role="search">
    ...
    // Ubah kueri SQL untuk mendapatkan data buku dan jumlah buku yang sedang dipinjam
    $query = "SELECT b.id_buku, b.kode_buku, b.judul_buku, b.kategori, b.pengarang, b.penerbit, b.thn_terbit, b.stok, b.id_rak, COUNT(p.id_peminjaman) AS total_dipinjam
    FROM buku b
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while($data = mysqli_fetch_array($result)) {
            ...
            <td><a href='detailbuku.php?judul_buku=<?php echo urlencode($data['judul_buku']); ?>'><?php echo $data['judul_buku']; ?></a></td>
            <td><?php echo $data['kategori']; ?></td>
            <td><?php echo $data['pengarang']; ?></td>
            <td><?php echo $data['penerbit']; ?></td>
            <td><?php echo $data['thn_terbit']; ?></td>
            <td><?php echo $stok_aktual; ?></td>
            <td><?php echo $data['id_rak']; ?></td>
            
            <?php
            // Tambahkan tombol atau tautan untuk tindakan yang ingin Anda lakukan, misalnya edit atau hapus
            echo "<td>";
            echo "<center>";
            echo "<a href='edit_buku.php?id_buku=" . $data['id_buku'] . "'> <button type='button' class='btn btn-outline-secondary'>";
            ...
            echo "Edit</button></a>";
            echo "<a href='hapus_buku.php?id_buku=" . $data['id_buku'] . "'> <button type='button' class='btn btn-danger'>";
